...
void MyGL::slot_jointRotXPos() {
    if(m_selectedJoint) {
        m_selectedJoint->rotation *= glm::angleAxis(glm::radians(5.f), glm::vec3(1, 0, 0));
        m_selectedJoint->resetMats();
    }
    update();
}
...
void MyGL::slot_jointRotYPos() {
    if(m_selectedJoint) {
        m_selectedJoint->rotation *= glm::angleAxis(glm::radians(5.f), glm::vec3(0, 1, 0));
        m_selectedJoint->resetMats();
    }
    update();
}
...
void MyGL::slot_jointRotZPos() {
    if(m_selectedJoint) {
        m_selectedJoint->rotation *= glm::angleAxis(glm::radians(5.f), glm::vec3(0, 0, 1));
        m_selectedJoint->resetMats();
    }
    update();
}
